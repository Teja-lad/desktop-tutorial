...
AWS_ACCESS_KEY_ID = 'AKIA5V6I7GOQMN32YL6G'
AWS_SECRET_ACCESS_KEY = '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'
...
def analyze_image():
    ...
    try:
        ...
        if detection_type == 'object':
            ...
            return jsonify({"error": "Invalid detection_type"}), 400
    ...
    results = [
        {
            ...
            'image_results': eval(item['image_results']),
